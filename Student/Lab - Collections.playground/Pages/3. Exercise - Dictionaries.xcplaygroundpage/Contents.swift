 ...
 */
var numberOfDaysInMonth = ["January": 31, "February": 28, "March": 31]
 ...
 */
if let numberOfDaysInJanuary = numberOfDaysInMonth["January"] {
    print("Janurary has \(numberOfDaysInJanuary) days")
}
/*:
