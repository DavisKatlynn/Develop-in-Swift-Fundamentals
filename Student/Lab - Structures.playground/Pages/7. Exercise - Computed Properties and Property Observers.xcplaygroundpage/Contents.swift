...
var rect = Rectangle(width: 11, height: 12)
print(rect.area)
/*:
...
struct Height {
    var heightInInches: Double {
        didSet {
            let updatedHeightInCentimeters = heightInInches * 2.54
            if heightInCentimeters != updatedHeightInCentimeters {
                heightInCentimeters = updatedHeightInCentimeters
            }
        }
    }
    ...
    var heightInCentimeters: Double {
        didSet {
            let updatedHeightInInches = heightInCentimeters / 2.54
            if heightInInches != updatedHeightInInches {
                heightInInches = updatedHeightInInches
            }
        }
    }
...
myHeight.heightInCentimeters = 149
print(myHeight.heightInInches)
