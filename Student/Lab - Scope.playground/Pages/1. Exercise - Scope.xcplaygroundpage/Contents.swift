...
//print("The value of foo is \(foo)")
// Because foo is not in global scope
...
// Here x is in global scope, hence it is accessable from anywhere
...
greeting(greeting: "Hi there", name: "Dias")
greeting(greeting: nil, name: "Dias")
/*:
